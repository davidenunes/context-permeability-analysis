...
params <- read.exp.parameters(param_file_name="../data/context_permeability/regular_networks/param-space_2014-05-30_16:47:53experiment:0_.csv")
...
Now to observe the distribution of the number of encounters, necessary to achieve consensus, we look at the box plots for **k = {1,2,3,4,5}** and **k = {10,20,30,40,50}** respectively. We look at **configurations with a number of networks > 3** since less networks tab1 <- tabular(Heading()*RowFactor(rowFactor2, spacing = 1, 
        ...
        data = mydf)require more connectivity to allow consensus to be reached 100% of the time.
